...
type Opts = {
  ...
  estado: EstadoPedido
  formaPago: FormaPago
  demoraCocina?: string      // "15-20 minutos"
  demoraRepartidor?: string  // "10-15 minutos"
}
...
export function armarMensajePedido(o: Opts): string {
  ...
  if (o.estado === "ordenado") {
    ...
    if (o.formaPago === "efectivo") {
      ...
      lineas.push(
        "",
        `Pagos por *${medio}*: tu orden *comenzará a prepararse* cuando el pago se confirme con éxito y nos envíes el *comprobante* (anticipo).`,
        "Cuando lo tengas, respóndenos con la captura."
      )
    }
