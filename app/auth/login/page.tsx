  ...
  return (
    <div className="min-h-[calc(100vh-140px)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="border border-zinc-800 rounded-2xl p-6 bg-zinc-950/80 space-y-5">
          <button
            type="button"
            onClick={handleGoogle}
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 h-11 rounded-lg border border-zinc-700 hover:border-zinc-500 bg-zinc-900 text-white font-medium transition-colors disabled:opacity-50"
          >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-zinc-950 px-3 text-zinc-500">o con correo</span>
            </div>
          </div>
